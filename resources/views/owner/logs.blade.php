            ...
            <div class="space-y-3">
                        ...
                        <div class="flex items-start gap-3.5">
                            ...
                            <div class="space-y-0.5">
                                <p class="text-xs md:text-sm font-mono font-bold text-slate-200 leading-tight">
                                    {{ $log->package_name ?? 'Aktivitas Log Terpaut' }}
                                </p>
                                <div class="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-slate-500 font-mono">
                                    <span class="text-amber-400/90 font-bold">
                                        <i class="fa-solid fa-user-shield mr-1"></i>Aktor: {{ $log->nama_pemesan ?? $log->customer_name ?? $log->user_name ?? 'System Engine' }}
                                    </span>
                                    <span><i class="fa-solid fa-server mr-1"></i>Node: 127.0.0.1:8000</span>
                ...
                @empty
                    <div class="rounded-2xl p-20 text-center border border-dashed border-white/10 bg-black/10">
                        ...
                        <p class="text-xs text-slate-600 font-mono mt-1">Status database: Clear / No Warning events captured.</p>
                    </div>
                @endforelse
            </div>
        </div>
